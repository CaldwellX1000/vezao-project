...
export default function BottomNav() {
  ...
  const labelClass = (path: string) =>
   ...
   return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-black/95 border-t border-white/10 h-16 pb-[env(safe-area-inset-bottom)] flex items-center justify-around z-50">
